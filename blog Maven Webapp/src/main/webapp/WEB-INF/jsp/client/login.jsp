    ...
    <div class="content-form">
        ...
        <input type="hidden" name="token" value='${token}' id="token">
            ...
            <div id="change_margin_3">
                <input class="content-form-signup"  lay-submit lay-filter="login" type="submit" value="登录">
            </div>
        </form>
    </div>
    <div class="content-login-description">没有账户？<a class="content-login-link" href="register.html">立即注册</a></div>
</div>
