      ...
      <div class="whisper-list">
        <div class="item-box">
          <div class="item">
            ...
            <div class="img-box">
              <img src="/static/client/img/wy_img1.jpg">
            </div>
            <div class="op-list">
          ...
          <div class="review-version layui-hide">
              <div class="form">
                <img src="/static/client/img/header2.png">
        ...
        <div class="item-box">
          <div class="item">
            ...
            <div class="img-box">
              <img src="/static/client/img/wy_img2.jpg">
              <img src="/static/client/img/wy_img3.jpg">
              <img src="/static/client/img/wy_img4.jpg">
            </div>
            <div class="op-list">
              <p class="like"><i class="layui-icon layui-icon-praise"></i><span>1200</span></p> 
              <p class="edit"><i class="layui-icon layui-icon-reply-fill"></i><span>1200</span></p>
        ...
        <div class="item-box">
          <div class="item">
            ...
            <div class="img-box">
              <img src="/static/client/img/wy_img5.jpg">
            </div>
            <div class="op-list">
              <p class="like"><i class="layui-icon layui-icon-praise"></i><span>1200</span></p> 
              <p class="edit"><i class="layui-icon layui-icon-reply-fill"></i><span>1200</span></p>
