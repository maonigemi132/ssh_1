  ...
  <div class="about-content">
    <div class="w1000">
      <div class="item info">
        ...
        <div class="cont">
          <img src="/static/client/img/xc_img1.jpg">
          <div class="per-info">
            <p>
        ...
        <div class="layui-fluid">
          <div class="layui-row">
            <div class="layui-col-xs6 layui-col-sm3 layui-col-md3">
              <div class="cont-box">
                <img src="/static/client/img/gr_img2.jpg">
                <p>80%</p>
              </div>
            </div>
            <div class="layui-col-xs6 layui-col-sm3 layui-col-md3">
              <div class="cont-box">
                <img src="/static/client/img/gr_img3.jpg">
                <p>80%</p>
              </div>
            </div>
            <div class="layui-col-xs6 layui-col-sm3 layui-col-md3">
              <div class="cont-box">
                <img src="/static/client/img/gr_img4.jpg">
                <p>80%</p>
              </div>
            </div>
            <div class="layui-col-xs6 layui-col-sm3 layui-col-md3">
              <div class="cont-box">
                <img src="/static/client/img/gr_img5.jpg">
                <p>80%</p>
              </div>
            </div>
          </div>
